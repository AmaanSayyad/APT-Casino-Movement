...
const sampleLeaders = [
  { name: 'PlinkoPro', country: 'US', winRate: 68, streaks: 3, time: '2h ago', winnings: '12,450 MOVE', color: '#FFD700' },
  { name: 'EdgeHunter', country: 'CA', winRate: 62, streaks: 4, time: '6h ago', winnings: '9,820 MOVE', color: '#C0C0C0' },
  { name: 'CenterMaster', country: 'UK', winRate: 59, streaks: 2, time: '1d ago', winnings: '7,360 MOVE', color: '#CD7F32' },
  { name: 'RiskTaker', country: 'DE', winRate: 52, streaks: 2, time: '2d ago', winnings: '5,180 MOVE', color: '#888' },
  { name: 'RowKing', country: 'JP', winRate: 48, streaks: 2, time: '5d ago', winnings: '4,120 MOVE', color: '#777' },
];
